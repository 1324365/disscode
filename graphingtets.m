% Define your data for different trials
% For example, let's say you have three trials with different sets of data
...
% Concatenate all trials into one matrix
...
% Create a vector specifying which trial each data point belongs to
...
% Convert categoricalColors to a categorical array
categoricalColors = categorical(categoricalColors);

% Create scatter plot using categorical colors
